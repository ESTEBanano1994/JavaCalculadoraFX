...
public class CalculadoraView {
    ...
    public CalculadoraView() {
        ...
        view.setStyle("-fx-background-color: #66CCB1");
    ...
    private Button nuevoBoton (String texto){
        ...
        btn.setStyle("-fx-background-color: #66CC79; -fx-text-fill:black; -ft-background-radius:5px;"
                + " -fx-cursor:hand;");
        
        btn.setOnMousePressed(e -> {
            btn.setStyle("-fx-background-color:#ADF7BC ; -fx-text-fill: black;");
            btn.setTranslateY(2);
        });

        
        btn.setOnMouseReleased(e -> {
            btn.setStyle("-fx-background-color: #ADF7E9; -fx-text-fill: black;");
            btn.setTranslateY(0);
        });
    ...
    private Button accionBoton (String texto){
        Button btn = new Button(texto);
        btn.setPrefSize(50, 50);
        btn.setStyle("-fx-background-color: #93E37B; -fx-text-fill:black; -ft-background-radius:5px;"
                + " -fx-cursor:hand;");
        
        btn.setOnMousePressed(e -> {
            btn.setStyle("-fx-background-color:#BFEDAF ; -fx-text-fill: black;");
            btn.setTranslateY(2);
        });
